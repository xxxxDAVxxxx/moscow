...
$(document).ready(function() { 
	...
	$('#registration-submit').click(function(){
		...
		$(	"input#company-pass-confirm," +
	    	...
	    	if($(this).val()==""){
	    		...
	    		$(this).prev(".registration-caption").children(".reg-error").html('����, ����������� � ����������');
	    		error=true;
	    	}
		});
	    if(error){
	    ...
	    if(!$("input#license-check").attr("checked")){
	    	$("input#license-check").parent().children(".reg-error").html("������������ � ������������ �����������");
	    	if(!error){
	...
	*/	
		        ...
		        , success: function(response) {
		        	if (response.success) {
		        		...
		        		if(response.error=="Invalid data"){
		        			$("#forgot-pass-messbox-center").children(".reg-error").html("������������ � ����� email ������� �� ���������������.");
		        		}
	...
	$('#auth-enter').click(function(){
	    ...
	    var regEmail = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
	    if (regEmail.test(email) == false) { 
	    	$("#auth").children(".reg-error").html("������������ email �����!");
	    	return false;
	    }  
	...
	$('#js-object-create-submit').click(function(){
		...
		if (location == '') {
			...
			$('#js-object-location').next().next(".reg-error").html('���� ����������� � ����������!');
			error=true;
		}
		if (name == '') {
			$('#js-object-name').focus();
			$("#js-object-name").next().next(".reg-error").html('���� ����������� � ����������!');
			error=true;
		}
		if(error){
			return;
